...
<body>
  ...
  <section class="hero" id="home">
    <h1>Selamat Datang Super Admin, <?= htmlspecialchars($_SESSION['nama']); ?>!</h1>
    <p>Ini adalah halaman dashboard khusus super admin. Anda dapat memantau dan mengelola admin serta user di sini.</p>
  </section>
